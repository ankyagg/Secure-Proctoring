...
- **Product-first density**: Balanced typography that prioritizes content visibility
- High-density layouts to minimize scrolling
- Realistic, high-fidelity monitoring (no unnecessary filters)
