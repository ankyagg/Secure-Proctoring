...
import { Code2, Shield, ChevronRight, Trophy, Zap, Users } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-100 flex flex-col">
      ...
      <header className="px-8 py-5 flex items-center justify-between border-b border-slate-200 bg-white/80 backdrop-blur-sm">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-slate-900 tracking-tight">CodeArena</span>
        </div>
        <span className="text-sm text-slate-400">Student-Friendly DSA Contest Platform</span>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-16">
        <div className="text-center mb-14 max-w-2xl">
          ...
          <h1 className="text-slate-900 mb-4" style={{ fontSize: "2.75rem", fontWeight: 700, lineHeight: 1.15 }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl">
          ...
          <button
            ...
            className="group bg-white border border-slate-200 rounded-2xl p-8 text-left hover:border-blue-400 hover:shadow-lg hover:shadow-blue-100/50 transition-all duration-200 cursor-pointer"
          >
            ...
            <h2 className="text-slate-900 mb-2" style={{ fontWeight: 600, fontSize: "1.2rem" }}>
              Enter as Student
            </h2>
            <p className="text-slate-500 text-sm mb-6 leading-relaxed">
              Join active contests, solve problems, and climb the leaderboard. Real-time
              judging with instant feedback.
            </p>
            <div className="flex items-center gap-2 text-blue-600 text-sm">
              <span>Go to Contest Lobby</span>
        ...
        <div className="mt-14 flex items-center gap-8 text-center">
          {[
            ...
            <div key={stat.label} className="flex flex-col items-center gap-1">
              <span className="text-slate-900" style={{ fontWeight: 700, fontSize: "1.35rem" }}>
                {stat.value}
              </span>
