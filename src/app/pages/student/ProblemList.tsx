    ...
    <div className="max-w-4xl mx-auto px-6 py-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-slate-500 text-sm">Weekly DSA Championship #42 · 5 problems</p>
        </div>
        <button
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2.5 mb-1.5 flex-wrap">
                  ...
                  <span
                    className={`text-xs px-2 py-0.5 rounded-full border ${diff.bg} ${diff.text} ${diff.border}`}
                  >
                    {problem.difficulty}
                  </span>
                </div>
