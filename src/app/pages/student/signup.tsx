            ...
            <div className="space-y-3">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-16 pr-8 py-5 bg-[#000000] border border-white/5 rounded-3xl text-white placeholder:text-[#2a2a2a] focus:outline-none focus:border-[#0099ff]/50 transition-all font-semibold text-[11px] tracking-wider"
                  required
                />
              </div>
            </div>
